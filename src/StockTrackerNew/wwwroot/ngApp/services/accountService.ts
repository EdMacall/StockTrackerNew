namespace StockTrackerNew.Services {
    ...
    export class AccountService {
        ...
        private storeUserInfo(userInfo) {
            // store user name
            this.$window.localStorage.setItem('userName', userInfo.userName);

            // store claims
            this.$window.localStorage.setItem('claims', JSON.stringify(userInfo.claims));
        }
        ...
        public getClaim(type) {
            var allClaims = JSON.parse(this.$window.localStorage.getItem('claims'));
    ...
    angular.module('StockTrackerNew').service('accountService', AccountService);
}
